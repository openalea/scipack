...
from openalea.core import IDict, IEnumStr, IInt, ISequence, IStr
...
ptline_style = Fa(uid="0ddb02774e7711e6bff6d4bed973e64a",
...
hist_style = Fa(uid="0ddb02784e7711e6bff6d4bed973e64a",
                name="Hist Style",
...
it2seq = Fa(uid="0ddb02794e7711e6bff6d4bed973e64a",
            name="Iterables to Sequence",
...
tuples2seq = Fa(uid="0ddb027a4e7711e6bff6d4bed973e64a",
                name="tuples2seq",
                ...
                inputs=(dict(name='seq1', interface=ISequence,
                             desc='list of 2 uples'),),
                outputs=(dict(name='vis_seq', interface=None),)
                )

__all__.append('tuples2seq')

dict2seq = Fa(uid="0ddb027b4e7711e6bff6d4bed973e64a",
              name="Dict to Sequence",
